...
class _WebFRemoteVideo extends StatefulWidget {
  @override
...
class VideoPlayerElement extends WidgetElement {
  ...
  void initializeMethods(Map<String, BindingObjectMethod> methods) {
    ...
    methods['pause'] = AsyncBindingObjectMethod(call: (args) async {
  ...
  void initState() {
    ...
    _controller.addListener(() {
      setState(() {});
      if (_controller.value.isInitialized && playerState == PlayerState.init) {
